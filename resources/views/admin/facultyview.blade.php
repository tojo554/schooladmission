		...
		<div class="container-table100">
					...
					<table data-vertable="ver2">
						<thead>
							...
							<tr class="row100 head">
								...
								<th class="column100 column9" data-column="column9">Delete</th>
							</tr>
						</thead>
						<tbody>
         ...
         @foreach($admin as $faculty)
                 <tr class="row100">
                                ...
                                <td class="column100 column8" data-column="column8"><a class="btn btn-warning" href="/edit/{{$faculty->id}}/edit">  Edit  </a></td>
								<td class="column100 column9" data-column="column9"><a class="btn btn-danger" href="/delete/{{$faculty->id}}/delete"> Delete  </a></td>
