...
<div class="collapse" id="navbarToggleExternalContent">
  <div class="bg-light p-4">
   <a href="/faculty/dashboard"> <h5 class="text-dark h4">admin</h5></a>
    ...
    <div class="container">
        ...
        <br>
            ...
            <tr>
              ...
              <td><a href="/admin/studentview"><button class="btn btn-warning">View</button></a></td>
              
            </tr>
            <tr>
              <td>View all faculty</td>
              <td><a href="/admin/facultyview"><button class="btn btn-warning">View</button></a></td>
            </tr>
            <tr>
              <td>Edit Faculty</td>
              <td><a href="/admin/facultyview"><button class="btn btn-warning">View</button></a></td>
