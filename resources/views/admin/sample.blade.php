	...
	<nav class="fh5co-nav" role="navigation">
		...
		<div class="top-menu">
			<div class="container">
				<div class="row">
					<div class="col-xs-4">
						<div id="fh5co-logo"><i class="icon-study"></i> SBHSS<span>.Admin</span></div>
					</div>
					<div class="col-xs-15 text-right menu-1">
						...
						<li class="btn-cta"><a href="{{route('auth.logout')}}"><span>Logout</span></a></li>
						</ul>
					</div>
				</div>
			...
			<div class="row copyright">
				<div class="col-md-12 text-center">
					<p>
						...
						<small class="block">Designed by Tojo lawrence </small>
					</p>
				</div>
			</div>
