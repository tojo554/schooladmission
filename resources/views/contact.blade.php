...
<html>
				...
				<div class="row">
					<div class="col-xs-12 text-right">
						...
						<p class="num">Call: +0481 2721869</p>
							...
							<li><a href="/contact"><i class="icon-twitter2"></i></a></li>
							<li><a href="/contact"><i class="icon-dribbble2"></i></a></li>
							<li><a href="/contact"><i class="icon-github"></i></a></li>
						</ul>
					</div>
				</div>
			</div>
	...
	<aside id="fh5co-hero">
		<div class="flexslider">
			<ul class="slides">
		   	<li style="background-image: url(https://images.pexels.com/photos/1793393/pexels-photo-1793393.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940);">
