...
<div class="container">
		...
		<div class="row" style="margin: top 200px;">
            ...
            <div class="col col-12 col-sm-4 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                <b><center><h2>Login  </h2></center></b>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                     ...
                     <input type="password" class="form-control" name="password" placeholder="Enter password" values="{{ old('password') }}">
